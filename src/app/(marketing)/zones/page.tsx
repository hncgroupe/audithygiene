...
export const metadata: Metadata = {
  title: "Audit hygiène restaurant en Île-de-France, nos zones",
  description:
    "audit hygiène intervient dans les huit départements franciliens : Paris, 92, 93, 94, 77, 78, 91, 95. Trouvez votre département pour un audit hygiène et HACCP de votre restaurant.",
  ...
  return (
    <>
      ...
      <section className="container-ah py-16">
        <p className="eyebrow">Île-de-France</p>
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-ink sm:text-4xl">
          Audit hygiène restaurant partout en Île-de-France
        </h1>
