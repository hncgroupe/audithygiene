...
export const article: Article = {
  slug: 'cas-critique-non-conformite-majeure',
  title: 'Cas critique et non-conformité majeure : ce que l\'audit met en avant',
  metaTitle: 'Cas critique et non-conformité majeure en hygiène',
  description:
    "Écart mineur, non-conformité majeure, cas critique : la différence, des exemples concrets en cuisine, pourquoi ils sont isolés et comment les corriger sans délai.",
  excerpt:
    "Tous les écarts ne se valent pas. Voici comment distinguer un détail à améliorer d'un cas critique à impact sanitaire direct, avec des exemples de terrain et la marche à suivre.",
  category: 'Audit',
  ...
  blocks: [
    {
      type: 'p',
      text: "Sur le terrain, un audit ne se résume pas à une note. Il produit une liste d'écarts, et tous n'ont pas le même poids. Confondre un joint de chambre froide à remplacer avec une rupture de la chaîne du froid en plein service, c'est passer à côté de l'essentiel. La hiérarchie des non-conformités existe précisément pour éviter cette confusion. Elle dit ce qui peut attendre, ce qui doit être corrigé vite, et ce qui ne peut pas attendre une minute.",
    },
    {
      type: 'p',
      text: "Cette logique n'est pas une invention commerciale. Elle découle directement de la méthode HACCP, qui classe les dangers selon leur gravité et leur probabilité, et du règlement (CE) 852/2004, qui impose une obligation de résultat sur la sécurité des denrées. Comprendre la différence entre un écart mineur, une non-conformité majeure et un cas critique, c'est apprendre à lire son propre établissement comme le ferait un inspecteur, et à agir dans le bon ordre.",
    },
    {
      type: 'h2',
      id: 'definir-les-trois-niveaux-d-ecart',
      text: 'Les trois niveaux d\'écart, du détail au danger',
    },
    {
      type: 'p',
      text: "Un audit sérieux gradue ses constats. La plupart des grilles, comme la nôtre, distinguent trois niveaux. Ils ne se valent pas, et c'est tout l'intérêt de les séparer plutôt que de les additionner dans un score unique.",
    },
    {
      type: 'h3',
      text: 'L\'écart mineur',
    ...
    },
    {
      ...
      text: "Posez-vous une seule question : est-ce qu'un client pourrait tomber malade à cause de cet écart, aujourd'hui ? Si oui, c'est un cas critique. Si le risque existe mais reste différé parce qu'une barrière manque sans avoir encore cédé, c'est une non-conformité majeure. Si la sécurité du consommateur n'est pas directement en jeu, c'est un écart mineur.",
    },
    {
      type: 'h2',
      id: 'qu-est-ce-qu-un-cas-critique',
      text: 'Ce qui fait basculer un écart en cas critique',
    },
    {
      type: 'p',
      text: "Un cas critique se reconnaît à son impact sanitaire direct. Le vocabulaire de l'HACCP parle de danger : biologique (bactéries comme la salmonelle, la listeria, les staphylocoques), chimique (résidus de produits de nettoyage, allergène non signalé), ou physique (corps étranger). Quand un de ces dangers n'est plus maîtrisé sur un produit consommé, le point de maîtrise a cédé, et l'écart devient critique.",
    },
    {
      type: 'p',
      text: "La notion de point critique pour la maîtrise, le fameux CCP du Codex Alimentarius, éclaire la chose. À certains endroits du process, une cuisson, un maintien au froid, un refroidissement, c'est la seule barrière qui empêche le danger de se développer. Si cette barrière saute, il n'y a pas de filet de sécurité en aval. Un poulet mal cuit ne sera pas rattrapé plus loin dans la chaîne. C'est cette absence de rattrapage possible qui caractérise le cas critique.",
    },
    {
      type: 'h2',
      id: 'exemples-concrets-de-cas-critiques',
      text: 'Des cas critiques que l\'on rencontre vraiment',
    },
    {
      type: 'p',
      text: "Les exemples qui suivent ne sont pas théoriques. Ce sont des situations que tout auditeur croise, et que tout inspecteur sanctionne. Elles ont en commun de mettre un danger en contact direct avec ce que mangera le client.",
    },
    {
      type: 'ul',
      items: [
    ...
    {
      type: 'p',
      text: "Aucune de ces situations ne se règle par une note de bas de page dans un rapport. Chacune appelle une action immédiate : couper le froid défaillant et écarter les produits, jeter les denrées périmées, séparer les flux, arrêter la décongélation à l'air libre. Le rôle de l'audit est de les rendre visibles avant qu'elles ne deviennent un accident, ou une fermeture.",
    },
    {
      type: 'quote',
      text: "Un cas critique n'est pas une mauvaise note. C'est un produit qu'il faut sortir de la cuisine avant qu'il n'arrive dans une assiette.",
    },
    {
      type: 'h2',
      id: 'ecart-mineur-ou-majeur-comment-trancher',
      text: 'Mineur ou majeur : la frontière qui se discute',
    },
    {
      type: 'p',
      text: "La distinction entre cas critique et reste du lot est nette. Celle entre écart mineur et non-conformité majeure l'est moins, et c'est souvent là que se joue le sérieux d'un audit. Un même constat peut basculer d'un côté ou de l'autre selon son ampleur et sa récurrence.",
    },
    {
      type: 'p',
      text: "Prenez les relevés de température. Un oubli isolé sur une journée, dans un établissement qui consigne par ailleurs correctement, reste un écart mineur. L'absence totale de relevés depuis des semaines, dans un établissement qui ne sait pas dire si ses frigos tiennent la température, devient une non-conformité majeure : la maîtrise n'existe pas. Même thème, deux niveaux de gravité, parce que l'un est un accroc et l'autre une faille de système.",
    },
    {
      type: 'ul',
      items: [
    ...
    {
      type: 'callout',
      title: 'Pourquoi cette nuance compte',
      text: "Surclasser tous les écarts en cas critiques décrédibilise un rapport et noie les vraies urgences. Sous-classer un danger réel, à l'inverse, expose le client et l'établissement. Un bon audit assume cette gradation et l'explique, plutôt que de tout aligner pour faire monter ou baisser une note.",
    },
    {
      type: 'h2',
      id: 'pourquoi-on-isole-les-cas-critiques',
      text: 'Pourquoi un audit isole les cas critiques',
    },
    {
      type: 'p',
      text: "Dans notre méthode, comme dans toute démarche sérieuse, les cas critiques ne sont jamais fondus dans la note globale. Ils sont signalés à part, en tête de rapport. La raison est simple : un établissement peut afficher un score honorable sur la majorité des thèmes et présenter malgré tout un cas critique. Si on se contente de la moyenne, ce danger disparaît derrière les bons points.",
    },
    {
      type: 'p',
    ...
    {
      type: 'h2',
      id: 'ce-que-risque-l-etablissement',
      text: 'Ce que risque l\'établissement en contrôle officiel',
    },
    {
      type: 'p',
      text: "Ce qu'un audit privé signale comme cas critique, un contrôle officiel le sanctionne. Les agents de l'État, dans le cadre du règlement (UE) 2017/625, disposent d'une palette de suites graduées. Un écart mineur peut donner lieu à un simple rappel. Une non-conformité majeure conduit souvent à une mise en demeure assortie d'un délai. Un cas critique, lui, peut déclencher une mesure immédiate.",
    },
    {
      type: 'ul',
      items: [
    ...
    {
      type: 'p',
      text: "Autrement dit, le cas critique est exactement le type d'écart qui fait basculer une visite de routine en procédure lourde. C'est aussi celui qui coûte le plus cher, en denrées perdues, en jours de fermeture éventuels et en confiance des clients. Le traiter en amont, lors d'un audit, revient à désamorcer ce risque avant qu'il ne soit constaté par une autorité.",
    },
    {
      type: 'h2',
      id: 'corriger-un-cas-critique-sans-delai',
      text: 'Corriger un cas critique sans délai',
    },
    {
      type: 'p',
      text: "Face à un cas critique, la première action ne se discute pas : on protège le consommateur, tout de suite. La correction de fond vient ensuite. Voici la séquence que nous recommandons, et que nous appliquons quand un auditeur en détecte un pendant une visite.",
    },
    {
      type: 'ol',
      items: [
        "Mettre le danger hors d'atteinte : retirer immédiatement de la vente et du service les denrées concernées, isoler ou jeter selon le cas.",
        "Stopper le process en cause : couper l'équipement défaillant, arrêter la pratique à risque (décongélation à l'air libre, utilisation d'une planche contaminée).",
    ...
    {
      type: 'callout',
      title: 'Corriger le geste ne suffit pas',
      text: "Jeter les produits périmés trouvés un jour donné, c'est traiter le symptôme. Tant que la rotation des stocks et le suivi des dates ne sont pas repris, le même cas critique reviendra à la prochaine visite. La vraie correction agit sur l'organisation qui a laissé le danger apparaître.",
    },
    {
      type: 'h2',
      id: 'prevenir-le-retour-des-cas-critiques',
      text: 'Empêcher les cas critiques de revenir',
    },
    {
      type: 'p',
      text: "Un cas critique isolé peut arriver à un établissement bien tenu : une panne de nuit, un produit oublié au fond d'une étagère. Ce qui distingue une cuisine maîtrisée, c'est sa capacité à les détecter tôt et à éviter qu'ils ne deviennent une habitude. Cela passe par les fondamentaux du plan de maîtrise sanitaire, appliqués pour de vrai.",
    },
    {
      type: 'ul',
      items: [
    ...
    {
      type: 'p',
      text: "Aucune de ces mesures n'est spectaculaire. Mises bout à bout, elles forment le système qui empêche un écart ordinaire de se transformer en cas critique. L'audit régulier sert justement à vérifier que ce système tient dans le temps, et pas seulement le jour où l'on s'y est préparé.",
    },
    {
      type: 'h2',
      id: 'cas-critique-et-rapport-d-audit',
      text: 'Cas critique et rapport d\'audit : comment ça se lit',
    },
    {
      type: 'p',
      text: "Dans le rapport que nous remettons, les cas critiques apparaissent en évidence, séparés de la notation par thème. Chaque non-conformité est décrite, photographiée, et associée à une action corrective, une priorité et un délai conseillé. Le lecteur voit donc d'un coup d'oeil ce qui relève du danger immédiat et ce qui relève de l'amélioration continue.",
    },
    {
      type: 'p',
      text: "Cette présentation n'est pas un score officiel. audit hygiène est un label privé indépendant, et sa méthode de notation lui appartient. Elle ne se substitue pas à l'évaluation des services de l'État ni au dispositif Alim'confiance, et elle ne garantit pas le résultat d'un contrôle. Sa valeur est ailleurs : vous donner, en interne, une lecture honnête et hiérarchisée de votre niveau réel, pour agir avant que quiconque ne vous l'impose.",
    },
    {
      type: 'p',
      text: "Pour aller plus loin sur la façon de lire et d'exploiter ce document, le détail de la notation et du plan correctif est expliqué dans notre guide dédié au rapport d'audit. Et si un cas critique est détecté chez vous, l'essentiel n'est pas la note : c'est la rapidité avec laquelle vous le faites disparaître.",
    },
  ],
  faq: [
    {
      q: 'Quelle est la différence entre une non-conformité majeure et un cas critique ?',
      a: "La non-conformité majeure traduit une perte de maîtrise sérieuse sur un point de sécurité, mais sans danger immédiat le jour de la visite (par exemple un PMS absent ou aucun relevé de température). Le cas critique, lui, présente un danger direct et immédiat pour le consommateur : un produit qui peut rendre malade est en service ou sur le point de l'être. Le premier appelle une correction rapide et encadrée, le second une action sur-le-champ.",
    },
    {
      q: 'Un écart mineur peut-il devenir un cas critique ?',
      a: "Oui, par accumulation ou par négligence prolongée. Un oubli isolé de relevé de température est mineur. Mais si l'absence de suivi se généralise et qu'une armoire dérive sans que personne ne le voie, on peut aboutir à une rupture de la chaîne du froid, qui est un cas critique. C'est tout l'intérêt de corriger les écarts mineurs avant qu'ils ne fragilisent une barrière de sécurité.",
    },
    {
      q: 'Pourquoi les cas critiques sont-ils signalés séparément dans un audit ?',
      a: "Parce que la sécurité sanitaire n'est pas une moyenne. Un établissement peut avoir un bon score général et présenter malgré tout un danger immédiat. Si ce danger est dilué dans la note globale, il disparaît. Isoler les cas critiques garantit qu'ils sont traités en priorité, conformément à la logique HACCP et au règlement (CE) 852/2004.",
    },
    {
      q: 'Que faire si un auditeur détecte un cas critique pendant la visite ?',
      a: "On protège d'abord le consommateur : retrait immédiat des denrées concernées, arrêt du process en cause. On évalue ensuite l'étendue du problème, on trace l'incident dans le cadre du PMS, puis on corrige la cause de fond (équipement, organisation, formation) et on vérifie que la correction tient dans la durée.",
    },
    {
      q: 'Un cas critique entraîne-t-il forcément une fermeture lors d\'un contrôle officiel ?',
      a: "Pas systématiquement. Les suites dépendent de la gravité, du contexte et de la réactivité de l'établissement. Dans le cadre du règlement (UE) 2017/625, l'éventail va du retrait des denrées à la mise en demeure, au procès-verbal, voire à la fermeture administrative quand le danger pour le consommateur le justifie. La décision appartient aux autorités compétentes.",
    },
    {
      q: 'audit hygiène peut-il garantir l\'absence de cas critique lors d\'un contrôle ?',
      a: "Non. audit hygiène est un label privé indépendant. Il vous aide à détecter et corriger les cas critiques en amont, mais il ne se substitue pas au contrôle officiel et ne garantit pas son résultat. Sa valeur est de réduire le risque en vous donnant une vision claire et hiérarchisée de votre conformité réelle.",
    },
    {
      q: 'Les allergènes peuvent-ils constituer un cas critique ?',
    ...
    {
      q: 'Comment éviter durablement les cas critiques ?',
  ...
  sources: [
    ...
    {
      label: 'Codex Alimentarius - principes généraux et HACCP (FAO/OMS)',
      url: 'https://www.fao.org/fao-who-codexalimentarius/',
    },
    {
      label: 'Arrêté du 21 décembre 2009 relatif aux températures de conservation',
    ...
    {
      label: 'ANSES - dangers biologiques et sécurité sanitaire des aliments',
      url: 'https://www.anses.fr/',
    },
    {
      label: 'DGCCRF - hygiène et sécurité des aliments en restauration',
      url: 'https://www.economie.gouv.fr/dgccrf',
    },
    {
      label: "Ministère de l'Agriculture - hygiène en restauration commerciale",
  ...
  relatedZones: ['paris', 'seine-saint-denis', 'hauts-de-seine'],
};
